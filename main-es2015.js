...
const routingComponents = [_app_store_checkout_homepage_store_checkout_homepage_component__WEBPACK_IMPORTED_MODULE_4__["StoreCheckoutHomepageComponent"], _app_payment_confirmation_payment_confirmation_component__WEBPACK_IMPORTED_MODULE_3__["PaymentConfirmationComponent"]];
...
let PaymentConfirmationComponent = class PaymentConfirmationComponent {
    constructor(dialog, printService, router) {
        this.dialog = dialog;
...
// --------------------Cash Popup-------------------------------
let CashPaymentComponentCashDialog = class CashPaymentComponentCashDialog {
...
CashPaymentComponentCashDialog.ctorParameters = () => [
...
let ConfirmPaymentComponentDialog = class ConfirmPaymentComponentDialog {
...
ConfirmPaymentComponentDialog.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
...
let StoreCheckoutHomepageComponent = class StoreCheckoutHomepageComponent {
    constructor(router) {
        this.router = router;
...
StoreCheckoutHomepageComponent.ctorParameters = () => [
